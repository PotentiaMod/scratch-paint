...
const MAX_STROKE_WIDTH = 9999999; // NOTE: in pm we can just expect the user to use this properly despite https://github.com/scratchfoundation/scratch-paint/issues/768
